...
public class ExpenseDatabase {
	...
	private static final String TABLE_3_CREATE = "create table "
			...
			+ " integer, " + tables3[EXPENSE_INT][1]
			+ " text , " + tables3[EXPENSE_INT][2]
					+ " TIMESTAMP DEFAULT CURRENT_TIMESTAMP PRIMARY KEY ," + tables3[EXPENSE_INT][3]+ " text," + tables3[EXPENSE_INT][4]+ " text,"+ tables3[EXPENSE_INT][5]+ " text"+ ");";
